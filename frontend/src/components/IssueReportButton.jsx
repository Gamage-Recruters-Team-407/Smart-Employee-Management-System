...
import { AlertCircle, X, FileText, ChevronDown, ChevronUp, Clock, AlertTriangle, CheckCircle } from "lucide-react";
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-3 flex-1">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Report any issues you encounter</p>
            </div>
          </div>
          <div className="flex gap-3">
            <button
              onClick={() => setExpanded(!expanded)}
              className="flex items-center gap-2 px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-lg font-medium transition"
            >
              {expanded ? (
                <>
          ...
          <div className="mt-6 pt-6 border-t space-y-4">
            {loadingIssues ? (
              ...
              <>
                ...
                {myIssues.length > 0 && (
                  <div>
                    ...
                    <div className="space-y-3">
                      {myIssues.map((issue) => (
                        <div key={issue._id} className="border rounded-lg p-4 hover:shadow-md transition">
                ...
                {/* All Other Issues (HR/Admin only) */}
